...
class VC_Image_ReOrdered: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "collectionViewCellx", for: indexPath) as! VC_Image_ReOrdered_CollectionCell
...
//collectionView代理实现
extension VC_Image_ReOrdered : UICollectionViewDelegateFlowLayout {
